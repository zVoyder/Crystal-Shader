Shader "Custom/Crystal"
{
    ...
    SubShader
    {
         ...
         **/
        half3 calculateRimLight(float3 viewDir, float3 worldNormal)
        {
            float fresnel = pow(1.0 - dot(normalize(viewDir), worldNormal), 3);
            return fresnel * _RimLightPower * _RimLightColor.rgb;
        }
        ...
        void surf(Input IN, inout SurfaceOutputStandardSpecular o)
        {
            ...
            o.Emission = calculateRimLight(IN.viewDir, IN.worldNormal);
        }
        ENDCG
    }
